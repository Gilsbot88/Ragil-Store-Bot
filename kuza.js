...
const simple = require('./lib/simple.js')
    ...
    let gopay = fs.readFileSync("./payment/QRIS-1.jpg");
    let ovo = fs.readFileSync("./payment/QRIS-2.jpg");
    let dana = fs.readFileSync("./payment/QRIS-3.jpg");
...
const ownerNumber = [`${owner}@s.whatsapp.net`, `623136890848@s.whatsapp.net`, `6283136890848@s.whatsapp.net`, `6282316153393@s.whatsapp.net`, `6282293271747@s.whatsapp.net`]
...
const katalog = (teks) => {
res = kuza.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 111119999, "message": teks, "footerText": "KuzaBotz😈", "thumbnail": fs.readFileSync('./media/pee.jpg'), "surface": 'CATALOG' }}, {quoted:fstatus})
...
const fstatus = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg","caption": "YT : ABIL BOTZ", 'jpegThumbnail': fs.readFileSync('./media/pee.jpg')}}}
...
❱ Status : *${isOwner ? 'Owner' :  'User'}*`,
 ...
 rows: [
                          ...
                          {
                              "title": "☰ Diamond HigsDomino",
                              "rowId": ".dmhigsdomino"
                          },
                          {
                              "title": "☰ Diamond Sausageman",
                              "rowId": ".dmsausageman"
                          },
                          {
...
{ buttonId: `.id`, buttonText: { displayText: 'MasukkanData' }, type: 1 },
